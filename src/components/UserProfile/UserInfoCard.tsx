            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div>
                    <Input id="info-x" type="text" label="X.com" value="https://x.com/PimjoHQ" onChange={() => {}} />
                  </div>
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    <Input id="info-first-name" type="text" label="First Name" value="Musharof" onChange={() => {}} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Input id="info-last-name" type="text" label="Last Name" value="Chowdhury" onChange={() => {}} />
                  </div>
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    <Input id="info-phone" type="text" label="Phone" value="+09 363 398 46" onChange={() => {}} />
                  </div>

                  <div className="col-span-2">
                    <Input id="info-bio" type="text" label="Bio" value="Team Manager" onChange={() => {}} />
                  </div>
                </div>
              </div>
            </div>
